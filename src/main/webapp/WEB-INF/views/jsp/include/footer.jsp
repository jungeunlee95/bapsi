...
<body>
   <section once="" class="cid-r4OiE1WjSq" id="footer7-5">
        ...
        <div class="media-container-row align-center mbr-white">
            <div class="row row-links">
                ...
                <li class="foot-menu-item mbr-fonts-style display-7">
                        <a class="mbr-bold text-secondary" href="#" target="_blank">About Us</a>
                    </li><li class="foot-menu-item mbr-fonts-style display-7">
                        <a class="mbr-bold text-secondary" href="#" target="_blank">Developer</a>
                    </li><li class="foot-menu-item mbr-fonts-style display-7">
                        <a class="mbr-bold text-secondary" href="#" target="_blank">Get In Touch</a>
                    </li><li class="foot-menu-item mbr-fonts-style display-7">
                        <a class="mbr-bold text-secondary" href="#" target="_blank">Careers</a>
                    </li><li class="foot-menu-item mbr-fonts-style display-7">
                        <a class="mbr-bold text-secondary" href="#" target="_blank">Ask</a>
                    </li></ul>
            </div>
            <div class="row social-row">
                ...
                <div class="soc-item">
                        ...
                        <a href="https://www.facebook.com/pages/Mobirise/1616226671953247" target="_blank">
                            <span class="mbr-iconfont mbr-iconfont-social socicon-facebook socicon" style="color: rgb(73, 92, 182);"></span>
                        </a>
                    </div><div class="soc-item">
                        ...
                        <a href="https://instagram.com/mobirise" target="_blank">
                            <span class="mbr-iconfont mbr-iconfont-social socicon-instagram socicon" style="color: rgb(180, 61, 176);"></span>
                        </a>
                    </div></div>
            </div>
            <div class="row row-copirayt">
                <p class="mbr-text mb-0 mbr-fonts-style mbr-white align-center display-7"><strong>
                    © Copyright 2018 Bapsi - All Rights Reserved
                </strong></p>
            </div>
        </div>
    </div>
