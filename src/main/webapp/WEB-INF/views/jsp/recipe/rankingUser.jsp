...
<section class="features3 cid-r4Q87j264d" id="features3-y">
        ...
        <div class="media-container-row">
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="${pageContext.request.contextPath}/resources/css/assets/images/01.jpg" alt="Mobirise" title="">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">
                            채희승</h4>
                        <p class="mbr-text mbr-fonts-style display-7">추천수 :&nbsp;<br>닉네임 :<br> 레시피 수 :
                        </p>
                    </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="${pageContext.request.contextPath}/resources/css/assets/images/02.jpg" alt="Mobirise">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">안병선</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
                            추천수 :&nbsp;<br>닉네임 :&nbsp;<br>레시피 수 :&nbsp;</p>
                    </div>
                    <div class="mbr-section-btn text-center"><a href="https://mobirise.com" class="btn btn-primary display-4">
                            게시글 보기</a></div>
                </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="${pageContext.request.contextPath}/resources/css/assets/images/03.jpg" alt="Mobirise">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">
                            박상현</h4>
...
<section class="features3 cid-r4Q9RAcDJV" id="features3-z">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="${pageContext.request.contextPath}/resources/css/assets/images/014.jpg" alt="Mobirise">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">
                            이정은</h4>
                        <p class="mbr-text mbr-fonts-style display-7">추천수 : 
<br>닉네임 :
<br>레시피 수 :</p>
                    </div>
                    <div class="mbr-section-btn text-center"><a href="https://mobirise.com" class="btn btn-primary display-4">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    ...
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">임지영</h4>
                        <p class="mbr-text mbr-fonts-style display-7">추천수 : 
<br>닉네임 :
<br>레시피 수 :</p>
                    </div>
