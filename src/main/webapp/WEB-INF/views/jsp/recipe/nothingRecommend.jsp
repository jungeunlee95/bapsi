...
<body>
   ...
   <section class="features3 cid-r4QcxVNCog" id="features3-17">
      	...
      	<h1 style="text-align:center; margin-bottom:40px;">조건에 맞는 레시피가 없습니다.</h1>
      		<br>
      		<br>
		<img src="${pageContext.request.contextPath}/resources/images/Bapsi_logo.png" style="width:400px; height:500px; margin-left:auto; margin-right:auto; display:block;"   alt="이미지를 불러올수 없습니다.">
