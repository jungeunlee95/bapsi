     ...
     <input type="hidden" name="keyword" value="${tCri.keyword}" />
      ...
      <div class="media-container-row" id="user_info2">  
         ...
         <div class="media-container-row">
            ...
            <h5 style="text-align: center; padding-top: 20px;" id="userNickName"><strong>${recipe.userNickName}</strong></h5>
            </a>
            <button id="follow"
            ...
            <div class="media-container-row">
                <c:if test="${ recipe.userNo eq userVO.no }">
                  <button type="button"
                     ...
                     &nbsp;&nbsp;
                  <button type="button"
                     onclick="location.href='${pageContext.request.contextPath}/recipe/delPage?no=${recipe.no}&page=${tCri.page}&numPerPage=${tCri.numPerPage}&findType=${tCri.findType }&keyword=${tCri.keyword }'" style="cursor:pointer;">삭제</button>
                  &nbsp;&nbsp;
               </c:if>
               <button type="button"
                  onclick="location.href='${pageContext.request.contextPath}/recipe/recipeTagList?page=${tCri.page}&numPerPage=${tCri.numPerPage}&TagName=${tag}&findType=${tCri.findType }&keyword=${tCri.keyword }'" style="cursor:pointer;">목록</button>
               &nbsp;&nbsp;<br> <br> <br> <br>
           </div>
            <hr>
