        ...
        <div class="media-container-row">
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    ...
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">간장계란밥</h4>
                        <p class="mbr-text mbr-fonts-style display-7">1,000원으로 느낄 수 있는소소한 행복!</p>
                    </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="${pageContext.request.contextPath}/resources/css/assets/images/026.jpg" alt="Mobirise">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">고추참치 볶음밥</h4>
                        <p class="mbr-text mbr-fonts-style display-7">단돈 2,000원으로<br>즐길 수 있는 간편요리!</p>
                    </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="${pageContext.request.contextPath}/resources/css/assets/images/037.jpg" alt="Mobirise">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">콘치즈</h4>
                        <p class="mbr-text mbr-fonts-style display-7">간단하고 해먹기 쉬운<br>단짠단짠 술안주</p>
                    </div>
...
<section class="features3 cid-r4QcQ2JfKt" id="features3-1a">
    ...
    <div class="container">
        <div class="media-container-row">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="${pageContext.request.contextPath}/resources/css/assets/images/015.jpg" alt="Mobirise">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">
                            꽁치김치찌개</h4>
                        <p class="mbr-text mbr-fonts-style display-7">소주를 부르는 <br>칼칼하고 시원한<br>꽁치김치찌개<br><br></p>
                    </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    ...
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">간장파스타</h4>
                        <p class="mbr-text mbr-fonts-style display-7">"박상현"씨의 추천메뉴<br>한국인의 입맛에 딱!<br>동서양의 절묘한 만남</p>
                    </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    ...
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">쌈장 볶음밥</h4>
                        <p class="mbr-text mbr-fonts-style display-7">남은 고기 몽땅 털어넣어<br>대충 비벼먹어도<br>고깃집을 능가하는<br>극강의 볶음밥!&nbsp;</p>
                    </div>
