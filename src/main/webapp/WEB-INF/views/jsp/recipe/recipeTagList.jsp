...
<body>
	...
	<section class="features3 cid-r4QcxVNCog" id="features3-17">
	 <h1 align="center" style="color: #5bb0ce;"># ${tagName }</h1> <br><br>
	 <div class="media-container-row">
         <div class="btn-group" role="group">
            ...
            <button id="findBtn"  class="form-control input-sm" style="cursor:pointer;">검색</button>
		...
		<div class="container">
			...
			<br> <br>
			 <button onclick="location.href='new'" class="form-control input-sm" style="align-content: center; cursor:pointer;">새글등록</button>
			<br> <br> <br>
			...
			<div class="btn-group" role="group" aria-label="Basic example"
				...
				<c:if test="${TpagingMaker.prev}">
					<button type="button" class="btn btn-outline-danger btn-sm"
						onclick="location.href='${pageContext.request.contextPath}/recipe/recipeTagList${TpagingMaker.makeFind(TpagingMaker.startPage-1)}'" style="cursor:pointer;">◀</button>
				</c:if>
				...
				<c:forEach begin="${TpagingMaker.startPage}"
					...
					<a
						...
						<button type="button"
							class="<c:out value="${TpagingMaker.cri.page == pNum?'btn btn-outline-danger btn-sm  active':' btn  btn-default btn-sm'}"/>" style="cursor:pointer;">
							${pNum}</button>
					</a>
				</c:forEach>
				<c:if test="${TpagingMaker.next&&pagingMaker.endPage>0}">
					<button type="button" class="btn btn-outline-danger btn-sm"
						onclick="location.href='${pageContext.request.contextPath}/recipe/recipeTagList${TpagingMaker.makeFind(TpagingMaker.endPage+1)}'" style="cursor:pointer;">▶</button>
				</c:if>
			</div>
			</div>
		</div>
