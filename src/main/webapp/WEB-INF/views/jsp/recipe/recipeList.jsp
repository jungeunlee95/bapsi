            ...
            <div class="btn-group" role="group" aria-label="Basic example"
               ...
               <c:if test="${pagingMaker.prev}">
                  <button type="button" class="btn btn-outline-danger btn-sm"
                     onclick="location.href='${pageContext.request.contextPath}/recipe/recipeList${pagingMaker.makeFind(pagingMaker.startPage-1)}'" style="cursor:pointer;">◀</button>
               </c:if>
               ...
               <c:if test="${pagingMaker.next&&pagingMaker.endPage>0}">
                  <button type="button" class="btn btn-outline-danger btn-sm"
                     onclick="location.href='${pageContext.request.contextPath}/recipe/recipeList${pagingMaker.makeFind(pagingMaker.endPage+1)}'" style="cursor:pointer;">▶</button>
               </c:if>
            </div>
         </div>
      </div>
